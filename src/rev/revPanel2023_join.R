# ==============================================================================
# Script 2 - Diagnostico de completeness: uso catastral (URBACLAVE) en el panel
...
# de uso catastral (URBACLAVE, Modulo 1 - VIVHAB) esta realmente disponible,
...
# que existen las columnas IN_VIVHAB / URBACLAVE / INGRESOS_INTEGROS con los
# valores que tienen.
...
# ------------------------------------------------------------------------------
# Completeness de URBACLAVE: universo completo (dt) vs. subconjunto de alquiler (dt_sub)
# ------------------------------------------------------------------------------
# is.na(URBACLAVE): tras el fix de fwrite/fread (na = "NA", ver README punto 8),
...
# ------------------------------------------------------------------------------
# Nota sobre los codigos de URBACLAVE distintos de "V" (p.ej. "A"): no indican
